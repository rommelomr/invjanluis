...
<table>
    <tr>
      ...
      <td class="tabla-cuerpo">
        BANCO:{{$personas->documentos->banco}}
        <br><br> 
        TIPO DE CUENTA:{{$personas->documentos->tipoCuenta}} 
        <br><br>
        NUMERO DE CUENTA:{{$personas->documentos->numCuenta}} 
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="tabla-titulo">Docuemtos</td>
      <td class="tabla-cuerpo">curriculum:{{$personas->documentos->curriculum}}/cerDeSalud:{{$personas->documentos->cerDeSalud}}/ otros:{{$personas->documentos->otros}}</td>
    </tr>
    <tr>
